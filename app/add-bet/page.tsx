            ...
            <CardContent>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="event" placeholder="e.g. Lakers vs Warriors" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="selection">Selection</Label>
                  <Input id="selection" placeholder="e.g. Lakers to win" />
                </div>
              </div>
            </CardContent>
            <CardFooter>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="border rounded-md p-4">
                    <p>Add your multi bet legs here</p>
                  </div>
                </div>
              </div>
            </CardContent>
            <CardFooter>
              <Button>Save Multi Bet</Button>
            </CardFooter>
          </Card>
        </TabsContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="arb-event" placeholder="e.g. Lakers vs Warriors" />
                </div>
              </div>
            </CardContent>
            <CardFooter>
              <Button>Save Arbitrage Bet</Button>
            </CardFooter>
          </Card>
        </TabsContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="dutch-event" placeholder="e.g. Melbourne Cup" />
                </div>
              </div>
            </CardContent>
            <CardFooter>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="back-event" placeholder="e.g. Man Utd vs Liverpool" />
                </div>
              </div>
            </CardContent>
            <CardFooter>
              <Button>Save Back & Lay Bet</Button>
            </CardFooter>
          </Card>
        </TabsContent>
      </Tabs>
